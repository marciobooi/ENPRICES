...
(function(a) {
    ...
    module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function(m) {
        a(m);
        a.Highcharts = m;
        return a
    ...
    function m(a, d, c, p) {
        a.hasOwnProperty(d) || (a[d] = p.apply(null, c),
    ...
    m(a, "Extensions/ExportData.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Utilities.js"], a["Extensions/DownloadURL.js"]], function(a, d, c, p, f, r, y) {
        function m(a, e) {
            ...
            try {
                ...
                if (!B)
                    return z.createObjectURL(new t.Blob(["\ufeff" + a],{
                        type: e
                    }))
            } catch (Q) {}
        }
        var w = this && this.__spreadArray || function(a, e, k) {
            if (k || 2 === arguments.length)
                for (var b = 0, z = e.length, g; b < z; b++)
                    !g && b in e || (g || (g = Array.prototype.slice.call(e, 0, b)),
                    g[b] = e[b]);
        ...
        d.prototype.getDataRows = function(b) {
            var e = this.hasParallelCoordinates, k = this.time, d = this.options.exporting && this.options.exporting.csv || {}, c = this.xAxis, g = {}, l = [], n = [], p = [], D;
            ...
            this.series.forEach(function(a) {
                var h = a.xAxis, q = a.options.keys || r(a, h), B = q.length, l = !a.requireSorting && {}, m = c.indexOf(h), z = L(a, q), f;
                if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
                    ...
                    a.options.data.forEach(function(b, u) {
                        ...
                        for (g[b].xValues[m] = v.x; f < B; )
                            u = q[f],
                            c = v[u],
                            g[b][A + f] = x(z.categoryMap[u][c], z.dateTimeValueAxisMap[u] ? k.dateFormat(d.dateFormat, c) : null, c),
                            f++
                    });
                    A += f
                }
            ...
            for (A = v.length; A--; ) {
                ...
                l.forEach(function(a) {
                    var b = a.name;
                    m && !M(b) && (m.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()),
                    b = k.dateFormat(d.dateFormat, a.x)) : b = m.categories ? x(m.names[a.x], m.categories[a.x], a.x) : a.x);
                    a.splice(H, 0, b)
                })
            }
            h = h.concat(l);
        ...
        d.prototype.getCSV = function(a) {
            ...
            k.forEach(function(a, e) {
                for (var c, l = a.length; l--; )
                    c = a[l],
                    "string" === typeof c && (c = '"' + c + '"'),
                    "number" === typeof c && "." !== d && (c = c.toString().replace(".", d)),
                    a[l] = c;
        ...
        d.prototype.getTableAST = function(a) {
            ...
            var l = g ? a.shift() : null
              ...
              , n = function(a, b, c, e) {
                ...
                "," === f && (d = d.replace(".", f)),
                b = "highcharts-number") : e || (b = "highcharts-empty");
                c = J({
                    "class": b
                }, c);
                return {
            ...
            c.push(function(a, b, c) {
                ...
                if (h) {
                    for (h = []; f < c; ++f) {
                        ...
                        l = 0) : (k === b[f] ? d.exporting.useRowspanHeaders ? (m = 2,
                        delete b[f]) : (m = 1,
                        b[f] = "") : m = 1,
                        k = n("th", "highcharts-table-topheading", {
                            scope: "col"
                        }, k),
                        1 < m && k.attributes && (k.attributes.valign = "top",
        ...
        d.prototype.toggleDataTable = function(a) {
            (a = x(a, !this.isDataTableVisible)) && !this.dataTableDiv && (this.dataTableDiv = l.createElement("div"),
            this.dataTableDiv.className = "highcharts-data-table",
            this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling));
            this.dataTableDiv && (this.dataTableDiv.style.display = a ? "block" : "none",
            a && (this.dataTableDiv.innerHTML = c.emptyHTML,
